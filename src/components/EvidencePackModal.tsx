  ...
  return (
    <div className="fixed inset-0 z-50 bg-stone-950/80 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full my-6 p-6 sm:p-8 border border-stone-300 shadow-2xl space-y-6 text-stone-900 text-xs print:p-0 print:border-none print:shadow-none">
        ...
        {/* Header Section with Official Uganda Styling */}
        <div className="border-b-2 border-stone-900 pb-4">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div>
              <div className="text-[10px] font-black tracking-widest text-emerald-900 uppercase">
                UGANDA COFFEE SUPPLY-CHAIN TRACEABILITY SYSTEM
              </div>
              <h1 className="text-xl font-black text-stone-900 mt-0.5 tracking-tight uppercase">
            ...
            <div className="text-left sm:text-right font-mono text-[11px] space-y-0.5 bg-stone-50 p-2 rounded border border-stone-200">
              ...
              <div><strong>System Layer:</strong> KaziTrace OS v1.0</div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t-2 border-stone-800 grid grid-cols-2 gap-8 text-[11px]">
          <div>
            <div className="text-stone-500 mb-6">Prepared & Verified By (Exporter Quality / Compliance Officer):</div>
          ...
          <div>
            <div className="text-stone-500 mb-6">Operations & Quality Authorization Signature:</div>
